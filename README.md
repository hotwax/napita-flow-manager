# napita-flow-manager for Ionic 5.x/ Vue applications
...
`git remote add napita-flow-manager https://github.com/hotwax/napita-flow-manager.git`

- Fetch napita-flow-manager branches
`git fetch napita-flow-manager`

- Merge napita-flow-manager master to your branch with [--allow-unrelated-histories](https://git-scm.com/docs/git-merge#Documentation/git-merge.txt---allow-unrelated-histories) flag
`git merge napita-flow-manager/main --allow-unrelated-histories`
...
1. Download the app from [release](https://github.com/hotwax/napita-flow-manager/releases) page and extract it.
...
2. Clone app using the command: `git clone https://github.com/hotwax/napita-flow-manager.git <repository-name>`
...
We are using firebase hosting for the Napita flow manager app deployment
...
2. Pick an issue from [here](https://github.com/hotwax/napita-flow-manager/issues). Write in the issue comment that you want to pick it, if you can't assign yourself. **Please stay assigned to one issue at a time to not block others**.
3. Create a branch for your edits. Use the following branch naming conventions: **napita-flow-manager/issue-number**.
4. Please add issue number to your commit message.
5. Propose a Pull Request to `main` branch containing issue number and issue title.
6. Use [Pull Request template](https://github.com/hotwax/napita-flow-manager/blob/main/.github/PULL_REQUEST_TEMPLATE.md) (it's automatically added to each PR) and fill as much fields as possible to describe your solution.
...
Napita flow manager app is completely free and released under the Apache v2.0 License. Check <a href="https://github.com/hotwax/napita-flow-manager/blob/main/LICENSE" target="_blank">LICENSE</a> for more details.
